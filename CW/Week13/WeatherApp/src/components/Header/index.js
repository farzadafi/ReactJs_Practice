...
export const Header = () => {
  const header = (ElementGenerator({
    element: 'div',
    className: 'flex px-8 py-2 dark:bg-gray-800 justify-between items-center',
    child: [
      ElementGenerator({
        element: 'label',
        ...
        child: [
          ...
          ElementGenerator({
            element: 'div',
            className: 'w-11 h-6 bg-gray-200 rounded-full peer dark:bg-gray-700 peer-focus:ring-4 peer-focus:ring-teal-300 dark:peer-focus:ring-teal-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[\'\'] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-teal-600'
          }),
          ElementGenerator({
            element: 'span',
